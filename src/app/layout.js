...
export const mobileNavItems = [
  ...
  { key: "map", label: "Площадки", href: "/locations" },
  {
    key: "products",
    label: "Продукция",
    children: [
      // 1) Грунт — от 1000
      {
        ...
        heroImageAlt: "Грунт",
        description:
          "Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях. Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.vГрунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.Грунт ВКУ применяется при возведении насыпей и благоустройстве территорий. Поддерживает стабильность оснований даже при сложных погодных условиях.",
        specifications: [
      ...
      // 6) Природный камень — от 500
      {
        key: "product-prirodny-kamen-copy",
        label: "Природный камень",
        price: "от 500 р./м³",
        imageSrc: "/images/products/prirodniy-kamen.webp",
        variant: "production",
